...
[grouping](#grouping-related-updates) and [cooldown settings](#cooldown-strategy) are more effective tools than reducing the limit.
Lowering the limit silently queues updates rather than making them visible.
