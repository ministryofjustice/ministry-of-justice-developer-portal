...
describe('PostHogSurvey', () => {
  ...
  beforeEach(() => {
    ...
    mockedPosthog.onSurveysLoaded.mockImplementation((callback) => {
      callback([])
      return () => {}
    })
  })
  ...
  it('starts the survey workflow when consent is accepted', () => {
    ...
    expect(displaySurveySpy).toHaveBeenCalledWith(
      '019f2899-14e8-0000-62d5-a37cff764a99',
      {
  ...
  it('starts the survey workflow after consent is accepted later', () => {
  ...
  it('never starts the survey workflow when the PostHog key is missing', () => {
    delete process.env.NEXT_PUBLIC_POSTHOG_KEY
    document.cookie = 'moj_cookie_consent=accepted'
