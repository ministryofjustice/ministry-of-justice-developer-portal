...
An [automated process](https://github.com/ministryofjustice/modernisation-platform/blob/main/.github/workflows/access-keys-monitoring.yml) runs every Monday at 7:30 AM to manage and delete unused access keys according to the criteria outlined for superadmin and collaborator users.
