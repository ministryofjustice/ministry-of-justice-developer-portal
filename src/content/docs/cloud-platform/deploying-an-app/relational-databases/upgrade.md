...
ingested_at: "2026-04-09T10:46:00.209Z"
...
> **Important for PostgreSQL databases with logical replication:** If your database has `rds.logical_replication` enabled, check the [RDS upgrade blockers troubleshooting guide](/docs/cloud-platform/other-topics/rds-upgrade-blockers) before upgrading to avoid upgrade failures caused by logical replication slots or pglogical nodes.
