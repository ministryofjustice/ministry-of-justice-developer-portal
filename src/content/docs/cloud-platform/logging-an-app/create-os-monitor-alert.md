...
ingested_at: "2026-04-09T10:46:00.214Z"
...
After merging PR, login to the [AWS console](/docs/cloud-platform/getting-started/accessing-the-cloud-console), search for `Secrets Manager` and navigate to the secret created in the previous step.
...
You may refer to our user guide [secret section](/docs/cloud-platform/deploying-an-app/add-secrets-to-deployment) for more information.
