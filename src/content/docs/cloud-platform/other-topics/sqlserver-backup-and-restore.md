...
ingested_at: "2026-04-09T10:46:00.239Z"
...
Because the RDS instance is created within it's own VPC you cannot directly access it from your local machine. See [Accessing your RDS database](/docs/cloud-platform/other-topics/rds-external-access) for how to forward traffic on port 1433 from your local machine to your RDS instance.
