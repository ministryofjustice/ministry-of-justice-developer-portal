...
Add the `ConfigMap` above to your namespace folder in the [environments repo][env-repo]. Once the ConfigMap is applied though the [Apply Pipeline](/docs/cloud-platform/other-topics/concourse-pipelines), your dashboard should be visible in Grafana shortly.
